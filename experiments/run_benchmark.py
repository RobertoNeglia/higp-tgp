...
def get_dataset(dataset_cfg):
    ...
    if name == "la":
        ...
        raise ValueError(
            f"Request access to the dataset at https://www.ucd.ie/issda/data/commissionforenergyregulationcer/"
        )
    else:
...
if __name__ == "__main__":
    exp = Experiment(
        run_fn=run_traffic, config_path="../config/benchmark", config_name="default"
    )
    exp.run()
